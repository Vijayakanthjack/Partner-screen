...
<head>
  ...
  <title>CREATE/MODIFY SERVICES</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <?php include "main_link_css.php"; ?>
  <!-- CREATE/MODIFY SHOPS CSS-->
  <link rel="stylesheet" href="dist/css/create-modify-services-style.css">
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header" id="dashboard-con">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="m-md-0 mb-2">CREATE/MODIFY SERVICES</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
                    ...
                    <table class="table table-striped table-responsive" width="100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Sambit</td>
                          <td>8067922333</td>
                          <td>Near Burger King Shop</td>
                          <td>
                            <div class="img-in"><img src="dist/img/lgs/logo-0001.jpg" alt="" class="img-fluid"></div>
                          </td>
                          <td>
                            <button class="btn btn-primary btn-sm" onclick="location.href='edit-mall-shops.php'">Edit
                              Serice</button>
                            <button class="btn btn-info btn-sm" onclick="location.href='edit-mall-shops.php'">Add
                              Shop</button>
                          </td>
                        </tr>
                        <tr>
