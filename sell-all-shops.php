...
<head>
    ...
    <title>SELl ALL SHOPS</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <?php include "main_link_css.php"; ?>
    <!-- SEL ALL SHOPS CSS-->
    <link rel="stylesheet" href="dist/css/sell-all-shops.css">
</head>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" id="dashboard-con">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <h1 class="m-md-0 mb-2">ALL SHOPS</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="back-bg">
                                <button class="btn btn-primary btn-sm" onclick="location.href='operations.php'"><i
                                                    ...
                                                    <div class="wrap-row">
                                                        <div>
                                                            <a href="shop-details.php">
                                                                <div class="img-in">
                                                                    <img src="dist/img/lgs/logo-0004.jpg"
                                                                        class="img-fluid">
                                                                </div>
                                                                <div class="content-in">
                                                                    <h3>CCD</h3>
                                                                    <p>9547878965</p>
                                                                    <button class="btn btn-warning btn-md">Visit
                                                                        Shop</button>
                                                                </div>
                                                            </a>
                                                        </div>
                                                        <div>
                                                            <a href="shop-details.php">
                                                                <div class="img-in">
                                                                    <img src="dist/img/lgs/logo-0005.jpg"
                                                                        class="img-fluid">
                                                                </div>
                                                                <div class="content-in">
                                                                    <h3>CCD</h3>
                                                        ...
                                                        <div>
                                                            <a href="shop-details.php">
                                                                <div class="img-in">
                                                                    <img src="dist/img/lgs/logo-0006.jpg"
                                                                        class="img-fluid">
                                                                </div>
                                                                <div class="content-in">
                                                                    <h3>CCD</h3>
